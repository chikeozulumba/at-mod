 ...
 * @constructor
 */
var PhoneCall = function (params) {

    return  {
        session: params.sessionId,
        isActive: params.isActive === 1,
        isComplete: params.isActive === 0,
        isInbound: params.direction === 'inbound',
...
function ExpressHandler(handle) {
    ...
    return [ // connect/express middleware
        ...
        function (req, res) {
            ...
            var call = new PhoneCall(req.body);

            call.respond = function (err, data) { // FIXME: Need better way to do this
                res.contentType("text/plain");
                res.status(err != null ? 500 : 200).send(data);
            };
